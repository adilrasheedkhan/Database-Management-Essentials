...
Insert into LOCATIONS (LOCNO,FACNO,LOCNAME) values ('L100','F100','Locker room');
Insert into LOCATIONS (LOCNO,FACNO,LOCNAME) values ('L101','F100','Plaza');
Insert into LOCATIONS (LOCNO,FACNO,LOCNAME) values ('L102','F100','Vehicle gate');
Insert into LOCATIONS (LOCNO,FACNO,LOCNAME) values ('L103','F101','Locker room');
Insert into LOCATIONS (LOCNO,FACNO,LOCNAME) values ('L104','F100','Ticket Booth');
Insert into LOCATIONS (LOCNO,FACNO,LOCNAME) values ('L105','F101','Gate');
Insert into LOCATIONS (LOCNO,FACNO,LOCNAME) values ('L106','F100','Pedestrian gate');
